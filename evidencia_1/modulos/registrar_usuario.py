import re
from evidencia_1.modulos.captcha import  comprobar_captcha
...
def validar_clave(clave):
    ...
    if condiciones_cumplidas >= 2:
        ...
        return False, "La clave debe cumplir al menos 2 de las siguientes condiciones: minúscula, mayúscula, número, carácter especial."
usuarios = {}
