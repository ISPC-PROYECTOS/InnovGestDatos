...
from evidencia_1.modulos.aritmetica import sumar, restar, multiplicar, dividir, promedio, suma_numeros
...
def comprobar_captcha():
    ...
    try:
        ...
        print("Entrada no válida. Captcha incorrecto.")
        return False
    
    if abs(respuesta - resultado) < 0.01:  # Tolerancia para errores de punto flotante
